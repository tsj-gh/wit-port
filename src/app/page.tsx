  ...
  return (
    <div className="mx-auto max-w-[1080px] w-full px-6">
      ...
      <main>
        ...
        <Suspense fallback={<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 pb-10 min-h-[320px]" />}>
          <HomePageLinks />
        </Suspense>

        <section className="pt-12 pb-8 border-t border-white/10 animate-fade-in-up-delay-more">
          ...
          <p className="text-wit-muted leading-relaxed mb-4">
            Wispoは、論理的思考力と直感を育む知育パズルの無料サイトです。Pair-Link・Skyscraper・Reflec-Shot・Pres-Sure Judge（プレッシャージャッジ）など、様々なロジックパズルをブラウザで手軽にお楽しみいただけます。
          </p>
        ...
        <aside
          className="min-h-[90px] mt-12 mb-10 rounded-xl"
          aria-label="広告スペース"
          style={{ minHeight: 90 }}
        />
      </main>
