...
export default function HiddenStackPage() {
  return (
    <>
      ...
      <main className="mx-auto flex min-h-[100dvh] w-full max-w-3xl flex-1 flex-col px-4 py-2 md:py-3 lg:max-h-[100dvh] lg:max-w-[1400px] lg:overflow-hidden lg:px-6">
        <Suspense
          fallback={
