...
export function EducationalColumnWispoHeader() {
  return (
    <header className="mb-8 flex w-full items-center justify-between gap-3">
      <DevLink
        href="/"
        className="flex min-w-0 shrink-0 items-center gap-3 text-xl font-black leading-none tracking-wider text-wit-text no-underline hover:opacity-90 sm:text-2xl"
      >
