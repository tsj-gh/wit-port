    ...
    <>
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 pb-10 animate-fade-in-up-delay-more">
        ...
        >
          ...
          <h2 className="text-2xl font-bold mb-3">Pair-Link（ペアリンク）</h2>
        ...
        >
          <span className="text-5xl mb-6 inline-block animate-float">🪞</span>
          <h2 className="text-2xl font-bold mb-3">Reflec-Shot（リフレクショット）</h2>
          <p className="text-wit-muted text-[15px] leading-relaxed flex-grow mb-6">
            鏡の反射を予測してゴールを目指す、ボールとバンパーのロジックパズル。空間認識能力を養います。
          </p>
          <div className="flex items-center justify-center gap-2 bg-violet-500 text-white py-3 px-6 rounded-xl font-bold text-base w-full transition-colors group-hover:bg-violet-600">
            出航する（Play）
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <line x1="5" y1="12" x2="19" y2="12" />
              <polyline points="12 5 19 12 12 19" />
        ...
        >
          <span className="text-5xl mb-6 inline-block animate-float">🏢</span>
          <h2 className="text-2xl font-bold mb-3">Skyscraper（スカイスクレイパー）</h2>
          <p className="text-wit-muted text-[15px] leading-relaxed flex-grow mb-6">
        ...
        >
          ...
          <h2 className="text-2xl font-bold mb-3">Pres-Sure Judge（プレッシャージャッジ）</h2>
          <p className="text-wit-muted text-[15px] leading-relaxed flex-grow mb-6">
      ...
      <div className="mb-10 flex flex-col items-center gap-3 px-0 animate-fade-in-up-delay-more">
        <DevLink
          ...
          className="inline-flex w-full max-w-xl items-center justify-center rounded-xl border border-sky-500/50 bg-sky-500/15 px-6 py-3.5 text-center text-base font-semibold text-sky-200 no-underline transition-colors hover:bg-sky-500/25 sm:w-auto sm:min-w-[320px]"
        >
          AI×モンテッソーリ：各パズルの知育効果について詳しく知る
        </DevLink>
      </div>
    </>
  );
